...
return array(
    ...
    "FEEDBACK_LOGIN_FIRST" => "Please login to use this function.",
    "FEEDBACK_NEW_GROUP_MAIL_SENDING_ERROR" => "Sorry, I tried to notify your group that you have joined but the notification email failed. ",
    "FEEDBACK_NEW_GROUP_MAIL_SENDING_SUCCESSFUL" => "Your group has just been notified that you have now joined them.",
    "FEEDBACK_AVAILABILITY_CREATION_FAILED" => "Availability creation failed.",
    "FEEDBACK_AVAILABILITY_EDITING_FAILED" => "Availability editing failed.",
    "FEEDBACK_AVAILABILITY_DELETION_FAILED" => "Availability deletion failed.",
);
